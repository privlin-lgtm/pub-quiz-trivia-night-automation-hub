  ...
  rounds: [
    {
      ...
      questions: [
        { text: "What is the capital of Australia?", answer: "Canberra", points: 1, type: QUESTION_TYPE.TEXT },
        { text: "How many continents are there?", answer: "Seven", points: 1, type: QUESTION_TYPE.TEXT },
        { text: "What planet is known as the Red Planet?", answer: "Mars", points: 1, type: QUESTION_TYPE.TEXT },
      ],
    },
    {
      title: "Flashback",
